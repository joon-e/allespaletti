...
[Paul Tol](https://personal.sron.nl/~pault/) developed various qualitative, sequential, and divergent color schemes that both beautiful and distinct for most people (e.g., various forms of color-blindness) and situations (screen, print-out, black and white copy).
...
Use `discrete = FALSE` in the call to `scale_fill_tol()` / `scale_color_tol()` to use these scales for continouos data.
